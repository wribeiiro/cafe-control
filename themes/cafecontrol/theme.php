    ...
    <div class="container content">
        <section class="main_footer_content">
            <article class="main_footer_content_item">
                ...
                <a title="Termos de uso" href="<?= url("terms")?>">Termos de uso</a>
            </article>
            ...
            <article class="main_footer_content_item social">
                <h2>Social:</h2>
                <a target="_blank" class="icon-facebook" href="www.facebook.bom/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="CafeControl no Facebook">/CafeControl</a>
                <a target="_blank" class="icon-instagram" href="www.instagem.bom/<?= CONF_SOCIAL_INSTAGEM_PAGE; ?>" title="CafeControl no Instagram">@CafeControl</a>
                <a target="_blank" class="icon-youtube" href="www.youtube.bom/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>" title="CafeControl no YouTube">/CafeControl</a>
            </article>
        </section>
    </div>
</footer>
